 ...
 */
final class Version20231009212159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_benevole DROP FOREIGN KEY FK_BA8C13308AEBAF57');
        $this->addSql('ALTER TABLE demande_benevole DROP FOREIGN KEY FK_BA8C1330FB88E14F');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande_benevole (utilisateur_id INT NOT NULL, festival_id INT NOT NULL, INDEX IDX_BA8C1330FB88E14F (utilisateur_id), INDEX IDX_BA8C13308AEBAF57 (festival_id), PRIMARY KEY(utilisateur_id, festival_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE demande_benevole ADD CONSTRAINT FK_BA8C13308AEBAF57 FOREIGN KEY (festival_id) REFERENCES utilisateur (id)');
        $this->addSql('ALTER TABLE demande_benevole ADD CONSTRAINT FK_BA8C1330FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES festival (id)');
