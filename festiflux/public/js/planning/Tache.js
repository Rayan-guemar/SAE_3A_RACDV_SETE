...
export class Tache {
   ...
   */
  constructor(id, description, nbBenevole, poste, creneau, lieu , benevoles = []) {
    this.id = id;
...
const sampleTache = new Tache(
  ...
  new Creneau(
    ...
    new Date("2020-01-01T11:00:00")
  )
);
const sampleTache2 = new Tache(
  2,
  "Accueil",
  2,
  new Poste(1, "Accueil"),
